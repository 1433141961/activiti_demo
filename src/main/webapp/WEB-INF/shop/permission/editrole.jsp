...
$(document).ready(function(){
	...
	$("input[name='offerGroupArea']").each(function(){
		...
		if('${area1.areaId}' == value && '${area1.Type}' == 2){
	...
	$("input[name='orderArea']").each(function(){
		var value = $(this).val();
		<c:forEach items='${role.list }' var="area1">
		if('${area1.areaId}' == value && '${area1.Type}' == 1){
			$(this).attr("checked",true);
		}
	    </c:forEach>
	});
...
<div class="frameR"><div class="content">
    ...
    <div class="loc icon"><samp class="t12"></samp><fmt:message key='menu.current.loc'/>：权限管理&nbsp;&raquo;&nbsp;<a href="<c:url value="/${system}//role/listRole.do"/>" title="角色管理">角色管理</a>&nbsp;&raquo;&nbsp;<span class="gray" title="编辑角色">编辑角色</span><a href="<c:url value="/${system}//role/listRole.do"/>" title="返回角色管理" class="inb btn120x20">返回角色管理</a></div>
	<form id="form111" name="form111" action="${base}//role/updateRole.do" method="post">
		<div class="edit set">
		 <div class="wp92">
            <div>
	...
	<input type="hidden" id="roleListUrl" name="roleListUrl" value="${base}//role/listRole.do" />
    <div class="loc">&nbsp;</div>
