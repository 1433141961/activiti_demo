...
$(document).ready(function(){
	 var options = { 
				 url:  "${base}//perm/assignPermForRole.do",
...
function showResponse(responseText, statusText){ 
	...
	if(obj.result=="success"){
		document.location="${base}//role/listRole.do"
	}
...
<div class="frameR"><div class="content">
	...
	<div class="loc icon"><samp class="t12"></samp><fmt:message key='menu.current.loc'/>：角色分配权限<a href="<c:url value="/${system}//role/listRole.do"/>" title="返回角色管理" class="inb btn120x20">返回角色管理</a></div>
	<form id="form1" name="form1" action="${base}//perm/assignPermForRole.do" method="post">
		<div class="edit set">
           	<table align="left">
           		<tr>
           			<td>
