...
<script type="text/javascript">
	...
	function batchStart(){
		...
		form.action="${base}//perm/batchUpdatePermStatus.do?status=1";
		form.submit();
	}
	function batchStop(){
		if(!isChecked()){
		...
		var form = document.getElementById("form1"); 
		form.action="${base}//perm/batchUpdatePermStatus.do?status=0";
		form.submit();
	}
	...
	function batchDel(){
		...
		if(confirm("确定删除这些记录")){
			var form = document.getElementById("form1"); 
			form.action="${base}//perm/batchDelPermById.do";
			form.submit();
		}
...
<form id="form1" name="form1" action="${base}//perm/listAllPerm.do" method="post">
	<div class="page_c">
        <span class="l">
            <c:url value="//perm/forwardperm.do" var="addperm"/>
    ...
    <!-- ======================================================================================================= -->
    <c:url value="//perm/getPerm.do" var="getPerm"/>
	<c:url value="//perm/deletePermById.do" var="deletePermById"/>
	<c:url value="//perm/updatePermStatus.do" var="start"/>
	<c:url value="//perm/updatePermStatus.do" var="stop"/>
