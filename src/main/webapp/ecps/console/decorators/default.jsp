...
<head>
    ...
    <title><decorator:title/>请假系统</title>
...
<div class="main">
    <%--  <c:if test="${currentMenu == 'AdminMenu'}">
         <div class="frameL"><div class="menu icon">
            <menu:useMenuDisplayer name="Velocity" config="cssVerticalMenu.vm" s="rolesAdapter">
...
<div id="editSimCardLabels" class="alt alt2" style="display:none">
    ...
    <div class="c set">
        ...
        <p style="margin-top:5px" align="center">
            <input type="button" id="lblQuery" name="lblQuery" class="hand btn83x23" value="确定"/>
        </p>
    </div>
    <div class="f"></div>
</div>
<div id="editSimCardLabels1" class="alt alt2" style="display:none">
    <div class="t"></div>
    <div class="c set">
        <h2 title="添加角色">添加角色</h2>
        <div id="editSimCardLabelsClose1" class="o" title="关闭"></div>
        ...
        <div id="pagelblID1" class="page_c"></div>

        <p style="margin-top:5px" align="center">
            <input type="button" id="lblQuery1" name="lblQuery" class="hand btn83x23" value="确定"/>
        </p>
    </div>
    <div class="f"></div>
</div>
